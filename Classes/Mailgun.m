...
- (id)initWithBaseURL:(NSURL *)url {
    ...
    if (self) {
        ...
        [s setHTTPMethodsEncodingParametersInURI:[s.HTTPMethodsEncodingParametersInURI setByAddingObject:@"POST"]];
        
        [self setRequestSerializer:s];
    }
    return self;
}
